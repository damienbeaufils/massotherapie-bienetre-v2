    ...
    <v-card-text class="pa-5 black--text">
      <v-row justify="center">
        <v-col cols="12">
          ...
          <p>
            <b
              >Il est important pour nous de commencer par ces étapes afin de
        ...
        <v-col cols="12">
          ...
          <p>
            ...
            <b
              >pour que cela fonctionne, les thérapeutes et les client.es
        ...
        <v-col cols="12">
          <h3 class="custom-color-green--text mb-5">Mes outils</h3>
          <p>
        ...
        <v-col cols="12">
          ...
          <ul>
            ...
            <li>
              ...
              vicieux de déchets qui s’accumulent et donc d’<b
                >améliorer la circulation des liquides dans la zone
                problématique</b
              >
              (<i
                >très indiquée pour les fibroses cervicales type bosse de bison
